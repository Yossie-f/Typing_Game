...
var roman2hiragana = {
  ...
  'kya':'キャ', 'kyu':'きゅ', 'kyo':'キョ',
  'sya':'シャ', 'syu':'シュ', 'syo':'ショ','sha':'シャ', 'shu':'シュ', 'sho':'ショ',
  ...
  'zya':'ジャ', 'zyi':'ジィ', 'zyu':'ジュ', 'zye':'じぇ', 'zyo':'ジョ',
  'ja':'ジャ', 'ju':'ジュ', 'je':'ジェ', 'jo':'ジョ', 'jya':'ジャ', 'jyi':'ジィ', 'jyu':'じゅ', 'jye':'ジェ', 'jyo':'ジョ',
  'dya':'ヂャ', 'dyi':'ヂィ', 'dyu':'ヂュ', 'dye':'ヂェ', 'dyo':'ヂョ',
  'bya':'ビャ', 'byi':'ビィ', 'byu':'ビュ', 'bye':'ビェ', 'byo':'ビョ',
  'pya':'ピャ', 'pyi':'ピィ', 'pyu':'ピュ', 'pye':'ピェ', 'pyo':'ピョ',
  'fa':'ファ', 'fi':'フィ', 'fe':'フェ', 'fo':'フォ',
  'fya':'フャ', 'fyu':'フュ', 'fyo':'フョ',
  'xa':'ァ', 'xi':'ィ', 'xu':'ゥ', 'xe':'ェ', 'xo':'ォ', 'la':'ァ', 'li':'ィ', 'lu':'ぅ', 'le':'ェ', 'lo':'ォ',
  'xya':'ャ', 'xyu':'ュ', 'xyo':'ョ',
  'xtu':'ッ', 'xtsu':'ッ',
  'wi':'ウィ', 'we':'ウェ',
